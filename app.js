...
var conversation_api = process.env.CONVERSATION_API || '<api_url>';
var logs = null;
  ...
  if ( !workspace_id || workspace_id === '<workspace-id>' ) {
    ...
    return res.json ( {
      'output': {
        ...
        '<a href="https://github.com/brucelau-github/aseproject">README</a> documentation on how to set this variable. <br>' +
